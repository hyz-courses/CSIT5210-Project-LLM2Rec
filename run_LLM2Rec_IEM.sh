...
CUDA_VISIBLE_DEVICES=0 /home/$USER/llm2rec-venv/bin/torchrun --nproc_per_node=1 --master_port=29502 ./llm2rec/run_unsupervised_SimCSE.py ./llm2rec/train_simcse_config.json
